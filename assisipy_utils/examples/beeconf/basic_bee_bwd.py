...
This bee randomly wanders a bit, backwards. It also changes color to indicate
...
class BasicBeeBwd(object):
    ...
    def __init__(self, bee_name, logfile, pub_addr, sub_addr, conf_file=None,
        ...
        if self.override_fwd_clr:
            ...
            # special demo to show the same config can be used for different
            # behavioural controllers (NOT a good way of doing it, so why is
            # this in demo?!)
            self.CLR_FWD[1] = 0.9
